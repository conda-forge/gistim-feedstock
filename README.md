...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gistim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11623&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gistim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gistim` can be installed with:

```
conda install gistim
```

It is possible to list all of the versions of `gistim` available on your platform with:
